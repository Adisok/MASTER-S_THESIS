...
class FileOperations:
    ...
    def save_file(self, textEditor, widget):
        """ Saving file """
        name = QFileDialog.getSaveFileName(widget, "Zapisz Plik", filter="Dane Textowe (*.txt)")
    ...
    def exit_file(self, app, widget):
        """ Closing application """
        choice = QMessageBox.question(widget, "Koniec", "Ciemność, widzę ciemność, ciemność widzę",
